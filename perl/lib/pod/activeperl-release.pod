=head1 ActivePerl 2201 -- Release Notes
...
attempt to use extensions or PPM packages built for ActivePerl 2000 and older
series builds with ActivePerl 2200 series builds and vice versa.  Please
check L<perl5220delta/Incompatible Changes> for known source level
...
was installed in F</opt/ActivePerl-5.22> then the HTML documentation
would be located in F</opt/ActivePerl-5.22/html>.
