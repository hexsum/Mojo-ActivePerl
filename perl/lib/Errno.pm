...
"x86_64-linux-thread-multi-3.2.0-24-virtual" or
	die "Errno architecture (x86_64-linux-thread-multi-3.2.0-24-virtual) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
